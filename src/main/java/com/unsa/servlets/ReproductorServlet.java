...
public class ReproductorServlet  extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String sum=req.getParameter("id");
		    ...
		    try {
		      ...
		      Object current=null;
		    	  for (SearchResult searchResult : searchResultList) {
		    		  System.out.println(searchResult.getId().getVideoId()+"=="+sum);
		    	  if (searchResult.getId().getVideoId().equals(sum)){
		      ...
		      req.setAttribute("current",current );
		       req.getRequestDispatcher("reproductor.jsp").forward(req, resp);
		     		      }
